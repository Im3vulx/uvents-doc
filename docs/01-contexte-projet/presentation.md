...
- **Accessibilité & qualité** : référentiels, état actuel, principes UI/UX
- **Tests** : état actuel, stratégie, Playwright, recette, plan d’évolution
- **Guides** : guide utilisateur et guide organisateur
- **Annexes** : glossaire, historique, liens utiles
...
- toute personne reprenant le projet ;
- les encadrants, jurys ou collaborateurs souhaitant comprendre le fonctionnement global ;
- l’exploitant du projet, pour la maintenance et les opérations courantes.

## Convention de lecture

Le projet ayant connu un changement de nom, certaines anciennes sources utilisent encore **Uvents**.
Dans cette documentation, le nom de référence est **ONY**, sauf lorsqu’un nom historique doit être mentionné pour expliquer un héritage technique ou documentaire.
...
Pour intervenir techniquement sur le projet :

1. Stack technique
2. Application
3. Base de données
4. Infrastructure & déploiement
5. Exploitation & debug

Pour maintenir le projet au quotidien :

1. Exploitation & debug
...
Cette documentation constitue désormais le référentiel principal du projet ONY.
